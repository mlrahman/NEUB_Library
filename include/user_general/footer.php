		...
		<footer class=" w3-center w3-black">
			<div class="w3-container w3-dark-gray w3-padding-large">
				<div class="w3-row">
					...
					<div style="padding: 0px 0px 0px 50px;" class="w3-third w3-container w3-mobile w3-left-align w3-hide-small w3-hide-medium">
						...
						<input class="w3-input w3-animate-input w3-border-teal w3-dark-gray" placeholder="Name" type="text" style="width:100%;margin:10px 0px;" autocomplete="off">
						<input class="w3-input w3-animate-input w3-border-teal w3-dark-gray" placeholder="Email" type="text" style="width:100%;margin:10px 0px;" autocomplete="off">
						<input class="w3-input w3-animate-input w3-border-teal w3-dark-gray" placeholder="Message" type="text" style="width:100%;margin:10px 0px;" autocomplete="off">
						<button class="w3-button w3-right w3-round w3-black w3-hover-teal"><i class="fa fa-send"> Submit</i></button>
					</div>
