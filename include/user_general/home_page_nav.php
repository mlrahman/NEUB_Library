...
<div class="w3-top">
	<div class="w3-bar w3-black w3-card">
		...
		<a href="index.php" class="w3-bar-item w3-button w3-padding-large w3-hover-teal w3-hide-large w3-hide-medium"><i class="fa fa-home"></i> Home</a>
		...
		<div class="w3-right">
			...
			<a href="#about_us" class="w3-bar-item w3-button w3-padding-large w3-hide-small w3-hover-teal"><i class="fa fa-newspaper-o"></i> About Us</a>
		</div>
	</div>
</div>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
	...
	<a href="borrow_status.php" class="w3-bar-item w3-button w3-padding-large w3-hover-teal" onclick="menu_toggle()"><i class="fa fa-edit"></i> Borrow Status</a>
	<a href="#about_us" class="w3-bar-item w3-button w3-padding-large w3-hover-teal" onclick="menu_toggle()"><i class="fa fa-newspaper-o"></i> About Us</a>
 </div>